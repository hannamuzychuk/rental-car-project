...
|------|--------|----------------|
| `NEXT_PUBLIC_SITE_URL` | `https://rental-car-goit.vercel.app` | Production (and Preview if you want the same OG URL on preview builds) |
...
**Live demo:** [https://rental-car-goit.vercel.app/](https://rental-car-goit.vercel.app/)
